...
// let EXAMPLE_CONNECTION_PROFILE_PATH = 'connection/path';
// let EXAMPLE_CHANNEL_NAME = 'channelExample';
// let EXAMPLE_CHAINCODE_NAME = 'UnitTests1';
// let EXAMPLE_CHAINCODE_PATH = 'chaincode/path/example';
// let EXAMPLE_CHAINCODE_VERSION = '1';
// let EXAMPLE_ORGNAME = 'sampleOrg';
// let EXAMPLE_CHAINCODE_TYPE : FabricClient.ChaincodeType = "node";
// let EXAMPLE_CREDENTIAL_FILE_PATH = 'credential/file/path';

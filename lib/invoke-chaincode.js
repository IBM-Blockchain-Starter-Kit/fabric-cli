...
var invokeChaincode = function (networkConfigFilePath, channelName, chaincodeName, chaincodeVersion, args,
	...
	console.log("AHA HERE>>>>>>>>>>>>>>> " + cryptoDir)

	let fabricHelper = new FabricHelper(networkConfigFilePath, channelName, path.join(process.env.HOME, 'fabric-client-kvs'), cryptoDir);

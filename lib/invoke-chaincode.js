...
var invokeChaincode = function (connectionProfilePath, channelName, chaincodeName, chaincodeVersion, args,
	functionName, org, queryOnly, timeout, cryptoDir) {
	logger.debug('============ Invoke chaincode method on organization ' + org + ' ============');

	let fabricHelper = new FabricHelper(connectionProfilePath, channelName, path.join(process.env.HOME, 'fabric-client-kvs'), cryptoDir);

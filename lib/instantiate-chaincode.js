...
var instantiateChaincode = function (networkConfigFilePath, channelName, chaincodeName, chaincodeVersion, args, functionName, org, upgrade) {
	...
	return helper.getOrgAdmin(org).then((user) => {
		...
		if (upgrade == "true") {
			...
			return channel.sendInstantiateProposal(request, 90000);
		}
	}).then((results) => {

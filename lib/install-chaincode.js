...
var installChaincode = function(connectionProfilePath, channelName, chaincodeName, chaincodePath,
	chaincodeVersion, org, cryptoDir) {
	logger.debug('\n============ Install chaincode on organizations ============\n');
	
	var helper = new FabricHelper(connectionProfilePath, channelName, path.join(process.env.HOME, 'fabric-client-kvs'), cryptoDir);

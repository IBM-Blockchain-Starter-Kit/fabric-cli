...
var invokeTransaction = function(networkConfigFilePath, channelName, chaincodeName, chaincodeVersion, args, functionName, org) {
	...
	return helper.getOrgAdmin(org).then((user) => {
		...
		logger.error('Failed invoking chaincode');
		logger.error(err);
	});
};
